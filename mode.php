...
<body>
<div  style="margin-right:auto;margin-left: auto;width:60%;color: black;">
	<header>
		<h1 id="a" >facebook</h1>
		<a href="welcome.php" style="color: black;text-decoration: none;" id="may">Dark Mode</a>
		<a href="#" style="color: black;"><i class="fa fa-search" id="b"></i></a>
		<a href="#" style="color: black;"><i class="fa fa-list" id="c"></i></a>
</header>
<main >
	<a href="mode.php" style="color: black;"><i class="fa fa-home" id="d"></i></a>
	<a href="#" style="color: black;"><i class="fa fa-users" id="e"></i></a>
	<a href="#" style="color: black;"><i class="fab fa-facebook-messenger" id="f"></i></a>
	<a href="#" style="color: black;"><i class="fa fa-bell" id="g"></i></a>
	<a href="#" style="color: black;"><i class="fa fa-tv video screen" id="h"></i></a>
	<a href="#" style="color: black;"><i class="fa fa-box" id="i"></i></a>
</main>
<hr>
<aside>
	<div><!-- <img src="img/IMG_20190818_155825_895.jpg" width="100%" id="j" height="80%" style="border-radius:100%"> -->  <img src="img/<?= $img ?>" alt="profilpic" width="100%" height="80%" style="border-radius:100%"></div>
	<div style="width: 60%;">
		<a href="#" style="color: black;"><i class="fa fa-search" id="k">What is on your mind</i></a>
		</div>
		<div>
	<a href="#" style="color: black;"><i class="fa fa-images" id="l"><br>Photos</i>
	</a>
</div>
</aside>
<hr>
...
<div id="r"><a href="#" style="color: black;" style="padding-left: 3%;">...</a>
<a href="#" style="padding-left: 4%; color: black;">X</a>
</div>
</div>
...
<div id="r"><a href="#" style="padding-left: 3%; color: black;">...</a>
<a href="#" style="padding-left: 4%;color: black;">X</a>
</div>
</div>
